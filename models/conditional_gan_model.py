...
class ConditionalGAN(BaseModel):
	...
	def backward_D(self):
		self.loss_D = self.discLoss.get_loss(self.netD, self.real_A, self.fake_B, self.real_B) # fake_B - real_B + gradient_penalty , fake_B = netG(real_A)
	...
	def optimize_parameters(self):
		...
		for iter_d in xrange(self.criticUpdates):
			...
			self.backward_D() # WGAN-GP的loss计算方法
